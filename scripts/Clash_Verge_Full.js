// 用于ClashVerge的全局拓展脚本
// source: https://github.com/tnnevol/ACL4SSR/blob/master/ClashVerge/dist/scripts/ACL4SSR_Online_Full.js
...
const rules = [
  ...
  ...[],
  // Steam规则
  "DOMAIN,steamcdn-a.akamaihd.net,🐬 自定义直连",
  "DOMAIN-SUFFIX,cm.steampowered.com,🐬 自定义直连",
  "DOMAIN-SUFFIX,steamserver.net,🐬 自定义直连",
  "DOMAIN-SUFFIX,shineee.site,🐬 自定义直连",
  // cloudflareStorge 直连
  "DOMAIN-SUFFIX,cloudflarestorage.com,🐬 自定义直连",
  // "PROCESS-NAME,steam.exe,🐬 自定义直连",
  "DOMAIN-SUFFIX,immersivetranslate.com,🐳 自定义代理",
  // "DOMAIN-SUFFIX,bing.com,🐳 自定义代理",
  "DOMAIN-SUFFIX,ulc.asu.edu, ⚙️ 节点选择",
  "DOMAIN-SUFFIX,m-team.cc, ⚙️ 节点选择",
  // 自定义规则
